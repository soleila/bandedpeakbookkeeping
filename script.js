...
let footerHTML = "<p>" + blogName + " is coded and designed by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://github.com/'>GitHub.</a></p>";
...
//Generate the Footer HTML, which uses the variables defined in the BASIC INFO section above to list info about the site.
//Note: feel free to remove the references to Zonelets and Neocities! Just be careful not to delete any necessary HTML closing tags or other syntax.
let footerHTML = "<hr><p>" + blogName + " is coded and designed by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://github.com/'>GitHub.</a></p>";
...
>>>>>>> 5e1a1a0569f80937ad92deb820b793196c07b3b7
